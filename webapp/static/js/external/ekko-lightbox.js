...
(function() {
    ...
    EkkoLightbox.prototype = {
        ...
        showYoutubeVideo: function(id) {
            this.resize(760, 415);
            return this.modal_body.html('<iframe width="760" height="415" src="//www.youtube.com/embed/' + id + '?autoplay=1" frameborder="0" allowfullscreen></iframe>');
        },
        ...
        checkImageDimensions: function(img) {
            ...
            if ((img.width + (this.padding.left + this.padding.right + 20)) > w.width()) {
                return img.width = w.width() - (this.padding.left + this.padding.right + 40);
            }
        }
    };
